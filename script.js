...
function openDiscordIntegration() {
  let discordIntegration = document.getElementById("discord-link");
  discordIntegration.style.display = "block";
}

function closeDiscordIntegration() {
  let discordIntegration = document.getElementById("discord-link");
...
function customDicePool() {
  ...
  historyEntry.innerHTML = discordMessage
    .replace(/\n/g, "<br>")
    .replace(/\*\*/g, "");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("open-discord-integration")
    .addEventListener("click", openDiscordIntegration);
  document
